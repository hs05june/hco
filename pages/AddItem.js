...
const AddItem = (props) => {
  ...
  return (
    ...
    <form className='absolute m-auto z-50 md:top-[3vh] top-[15vh] md:left-[34vw] shadow-xl rounded-md bg-light_color'>
        ...
        <input type='text' name='name' className='h-10 w-96 rounded-ld border-2 border-light_background focus:shadow-lg' id='name'/><br/>
        ...
        <input type='number' name='quantity' className='h-10 w-96 rounded-ld border-2 border-light_background focus:shadow-lg' id='quantity' /><br/>
        ...
        <input type='number' name='mrp' className='h-10 w-96 rounded-ld border-2 border-light_background focus:shadow-lg' id='mrp' /><br/>
        ...
        <input type='number' name='cp' className='h-10 w-96 rounded-ld border-2 border-light_background focus:shadow-lg' id='cp' /><br/>
        ...
        <input type='number' name='minimum' className='h-10 w-96 rounded-ld border-2 border-light_background focus:shadow-lg' id='minimum' /><br/>
        ...
        <div className='text-center'><button type='button' className='bg-blue rounded-md mt-3 text-white hover:cursor-pointer hover:bg-button_color shadow-lg px-5 py-2 my-2'>ADD ITEM</button></div>
        </div>
    </form>
    </Draggable>
  )
